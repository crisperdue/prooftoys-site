...
Prooftoys rewriting propagates names of bound variables from the input
...
When Prooftoys higher-order matching wraps a source term in n layers of
...
If the outer variable is a bound variable, Prooftoys first renames the
